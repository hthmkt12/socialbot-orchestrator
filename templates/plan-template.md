...
**Project Type**: [single/web/mobile - determines source structure]<br>
...
**Phase 3**: Task execution (/tasks command creates tasks.md)<br>
**Phase 4**: Implementation (execute tasks.md following constitutional principles)<br>
