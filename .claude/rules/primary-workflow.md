...
- Before finalizing a multi-phase plan, follow `./.claude/rules/plan-verification-rules.md`.
...
#### 5. Debugging
- Before fixing any bug, follow `./.claude/rules/bug-fix-rules.md` and check `docs/common-issues.md` first.
